...
const Calculator = () => {
  ...
  return (
    <div className="border-[3px] border-white/30 rounded-[10px] max-w-[600px] w-full overflow-hidden">
      <h1 className="text-center py-7 text-4xl">Scientific Calulator</h1>
